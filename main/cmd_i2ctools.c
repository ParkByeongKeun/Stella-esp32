...
i2c_master_bus_handle_t tool_bus_handle_i2c1;
i2c_master_bus_handle_t tool_bus_handle_i2c2;
...
static int do_i2cconfig_cmd(int argc, char **argv)
{
    ...
    // re-init the bus
    if (i2c_del_master_bus(tool_bus_handle_i2c1) != ESP_OK) {
        return 1;
    }
    ...
    if (i2c_new_master_bus(&i2c_bus_config, &tool_bus_handle_i2c1) != ESP_OK) {
        return 1;
    }
...
static int do_i2cget_cmd(int argc, char **argv)
{
	...
	ESP_LOGW("shcho test", "chip_addr=0x%02x", chip_addr);
