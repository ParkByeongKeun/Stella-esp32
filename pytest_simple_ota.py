...
#/ijoon_s1/Project/ESP32/example_v521/system/ota/simple_ota_example/pytest_simple_ota.py:93: DeprecationWarning: ssl.wrap_socket() is deprecated, use SSLContext.wrap_socket()
